...
//    XML_NOT_ETSI, XAdES_BES, XAdES_EPES, XAdES_T, XAdES_LT, XAdES_C, XAdES_X, XAdES_XL, XAdES_A, XAdES_BASELINE_B, XAdES_BASELINE_T, XAdES_BASELINE_LT, XAdES_BASELINE_LTA,
    ...
    PDF_NOT_ETSI(PAdES), PKCS7_B(PAdES), PKCS7_T(PAdES), PKCS7_LT(PAdES), PKCS7_LTA(PAdES), PAdES_BASELINE_B(PAdES),
    PAdES_BASELINE_T(PAdES), PAdES_BASELINE_LT(PAdES), PAdES_BASELINE_LTA(PAdES),
